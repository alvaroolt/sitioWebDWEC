...
function crearEtiquetas() {
    ...
    for (let i = 1; i < 5; i++) {
        ...
        etiquetaUl.appendChild(etiquetaLi); //appendChild anexa la etiquetaLi en etiquetaUl (añade ese li al ul)
    }
    document.body.appendChild(etiquetaUl); //appendChild anexa la etiquetaUl en el body de nuestro html
}
